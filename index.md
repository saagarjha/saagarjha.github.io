...
# Hi, I'm Saagar Jha.
I'm a software engineer who spends most of his time around the Bay Area. You can check out some of my work on my [projects]({{ site.baseurl }}/projects/) and [toys]({{ site.baseurl }}/toys/) pages. I also post some stuff on my [blog]({{ site.baseurl }}/blog/) or give [talks]({{ site.baseurl }}/talks/) from time to time. Still curious? You can find my résumé [here]({{ site.baseurl }}/resume.pdf).
...
- [@saagar@saagarjha.com](https://federated.saagarjha.com/users/saagar){: rel="me"} on ActivityPub
